...
class JobInterviewQuestModel extends JobInterviewQuest {
  const JobInterviewQuestModel({
    required super.id,
    super.type,
  ...
  factory JobInterviewQuestModel.fromJson(Map<String, dynamic> json) {
    return JobInterviewQuestModel(
