...
class ElevatorPitchScreen extends StatefulWidget {
  final int level;
  const ElevatorPitchScreen({super.key, required this.level});
...
class _ElevatorPitchScreenState extends State<ElevatorPitchScreen> {
  ...
  void initState() {
    ...
    context.read<RoleplayBloc>().add(
      FetchRoleplayQuests(
        gameType: GameSubtype.elevatorPitch,
        level: widget.level,
      ),
    );
  }
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect!
                ...
                : "PITCH REJECTED!",
            subtitle:
                "Pitch Tip: ${quest.explanation ?? "Start with a strong hook to grab attention."}",
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Master Pitcher!',
        description:
            'You earned $xp XP and $coins Coins. You nailed the presentation!',
        buttonText: 'HURRAY',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        ...
        description:
            'The investor lost interest. Refine your pitch and try again!',
        buttonText: 'QUIT',
        isSuccess: false,
        onButtonPressed: () {
          Navigator.pop(c);
