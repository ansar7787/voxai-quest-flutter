        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect!
                ...
                : "CONFUSING DATA!",
            subtitle:
                "Emergency Tip: ${quest.explanation ?? "Stay calm and provide your exact location first."}",
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Calm Hero!',
        description:
            'You earned $xp XP and $coins Coins. You save lives with clear words!',
        buttonText: 'HURRAY',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        ...
        description:
            'Help couldn\'t be sent because the report was unclear. Try again!',
        buttonText: 'QUIT',
        isSuccess: false,
        onButtonPressed: () {
          Navigator.pop(c);
