...
class ConflictResolverScreen extends StatefulWidget {
  final int level;
  const ConflictResolverScreen({super.key, required this.level});
...
class _ConflictResolverScreenState extends State<ConflictResolverScreen> {
  ...
  void initState() {
    ...
    context.read<RoleplayBloc>().add(
      FetchRoleplayQuests(
        gameType: GameSubtype.conflictResolver,
        level: widget.level,
      ),
    );
  }
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect!
                ...
                : "CONFLICT ESCALATED!",
            subtitle:
                "Diplomacy Tip: ${quest.explanation ?? "Use 'I' statements to express feelings without blaming."}",
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Peace Maker!',
        description:
            'You earned $xp XP and $coins Coins. Everyone is happy now!',
        buttonText: 'GREAT',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        ...
        description: 'The argument worsened. Try a more empathetic approach!',
        buttonText: 'QUIT',
        isSuccess: false,
        onButtonPressed: () {
          Navigator.pop(c);
