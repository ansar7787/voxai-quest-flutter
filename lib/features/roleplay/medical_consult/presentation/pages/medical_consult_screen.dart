...
class MedicalConsultScreen extends StatefulWidget {
  final int level;
  const MedicalConsultScreen({super.key, required this.level});
...
class _MedicalConsultScreenState extends State<MedicalConsultScreen> {
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect!
                ...
                : "UNCLEAR DATA!",
            subtitle:
                "Medical Tip: ${quest.explanation ?? "Be precise when describing physical sensations."}",
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Health Communicator!',
        description: 'You earned $xp XP and $coins Coins. Stay healthy!',
        buttonText: 'OK',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Misdiagnosis',
        description: 'Communication failed. Doctors need clear descriptions!',
        buttonText: 'QUIT',
        isSuccess: false,
        onButtonPressed: () {
          Navigator.pop(c);
