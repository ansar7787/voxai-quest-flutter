...
class GourmetOrderQuestModel extends GourmetOrderQuest {
  const GourmetOrderQuestModel({
    required super.id,
    super.type,
  ...
  factory GourmetOrderQuestModel.fromJson(Map<String, dynamic> json) {
    return GourmetOrderQuestModel(
