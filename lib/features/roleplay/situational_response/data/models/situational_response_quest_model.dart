...
class SituationalResponseQuestModel extends SituationalResponseQuest {
  const SituationalResponseQuestModel({
    required super.id,
    super.type,
  ...
  factory SituationalResponseQuestModel.fromJson(Map<String, dynamic> json) {
    return SituationalResponseQuestModel(
