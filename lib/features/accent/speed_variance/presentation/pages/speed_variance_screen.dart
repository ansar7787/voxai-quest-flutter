...
class _SpeedVarianceScreenState extends State<SpeedVarianceScreen> {
  ...
  void _analyzeSpeech() {
    ...
    // Speed variance checks for 80% word match + duration check (mocked for now)
    bool isCorrect =
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect!
                ? "PERFECT TEMPO!"
                : "ADJUST YOUR PACE!",
            subtitle: "Mastering the rhythm of talk.",
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Tempo Titan!',
        description:
            'You earned $xp XP and $coins Coins for your timing and control!',
        buttonText: 'GREAT',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
