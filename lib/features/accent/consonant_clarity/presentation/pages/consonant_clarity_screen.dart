...
class _ConsonantClarityScreenState extends State<ConsonantClarityScreen> {
  ...
  void _analyzeSpeech() {
    ...
    // Consonant clarity requires 85% similarity as it's about sharp sounds
    bool isCorrect =
        utteredText == targetText ||
        utteredText.contains(targetText) ||
        (targetText.contains(utteredText) &&
            utteredText.length > targetText.length * 0.85);
      ...
      children: [
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect! ? "CRISP DELIVERY!" : "STAY SHARP!",
            subtitle: "Every consonant counts.",
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        ...
        description:
            'You earned $xp XP and $coins Coins for your clear articulation!',
        buttonText: 'GREAT',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
