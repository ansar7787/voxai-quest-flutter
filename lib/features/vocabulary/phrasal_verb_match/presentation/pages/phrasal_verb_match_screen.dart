...
class PhrasalVerbMatchScreen extends StatefulWidget {
  final int level;
  const PhrasalVerbMatchScreen({super.key, required this.level});

  @override
  State<PhrasalVerbMatchScreen> createState() => _PhrasalVerbMatchScreenState();
}

class _PhrasalVerbMatchScreenState extends State<PhrasalVerbMatchScreen> {
  ...
  void initState() {
    ...
    context.read<VocabularyBloc>().add(
      FetchVocabularyQuests(
        gameType: GameSubtype.phrasalVerbs,
        level: widget.level,
      ),
    );
  }
      ...
      children: [
                      ...
                      return Padding(
                            ...
                            child: ScaleButton(
                              ...
                              child: GlassTile(
                                ...
                                borderColor:
                                    (state.hintUsed && index == correctIndex)
                                    ? theme.primaryColor
                                    : (isSelected &&
                                              state.lastAnswerCorrect != null
                                          ? Colors.white.withValues(alpha: 0.5)
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect! ? "PHRASAL MASTER!" : "ALMOST!",
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Verb Victor!',
        description:
            'You earned $xp XP and $coins Coins for mastering the mix!',
        buttonText: 'GREAT',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Mix-up!',
        description:
            'Phrasal verbs can be confusing. Review the particles and try again!',
        buttonText: 'RETRY',
        isSuccess: false,
        onButtonPressed: () {
          Navigator.pop(c);
