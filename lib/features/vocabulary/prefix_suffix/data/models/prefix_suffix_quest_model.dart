...
class PrefixSuffixQuestModel extends PrefixSuffixQuest {
  const PrefixSuffixQuestModel({
    required super.id,
    super.type,
  ...
  factory PrefixSuffixQuestModel.fromJson(Map<String, dynamic> json) {
    return PrefixSuffixQuestModel(
