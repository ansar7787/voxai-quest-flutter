...
class PrefixSuffixRepositoryImpl implements PrefixSuffixRepository {
  ...
  @override
  Future<Either<Failure, List<PrefixSuffixQuest>>> getPrefixSuffixQuests(int level) async {
    if (await networkInfo.isConnected) {
      try {
        final remoteQuests = await remoteDataSource.getPrefixSuffixQuests(level);
