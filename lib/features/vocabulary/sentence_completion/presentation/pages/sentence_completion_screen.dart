...
class _SentenceCompletionScreenState extends State<SentenceCompletionScreen> {
  ...
  void _onOptionSelected(int index) {
    ...
    if (state is VocabularyLoaded) {
      final isCorrect = index == state.currentQuest.correctAnswerIndex;
      if (isCorrect) {
      ...
      children: [
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _buildOptionCard(
                            ...
                            isCorrect: isCorrect,
                            showResult: state.lastAnswerCorrect != null,
                            isDark: isDark,
                            theme: theme,
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect! ? "SENTENCE COMPLETE!" : "ALMOST!",
  ...
  Widget _buildOptionCard({
    ...
    } else if (hintUsed && index == correctIndex) {
    ...
    return Padding(
      ...
      child: ScaleButton(
        ...
        child: GlassTile(
          ...
          borderColor: (hintUsed && index == correctIndex)
              ? theme.primaryColor
              : (isSelected && lastAnswerCorrect != null
                    ? Colors.white.withValues(alpha: 0.5)
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Sentence Savior!',
        description:
            'You earned $xp XP and $coins Coins for the perfect completions!',
        buttonText: 'AWESOME',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
