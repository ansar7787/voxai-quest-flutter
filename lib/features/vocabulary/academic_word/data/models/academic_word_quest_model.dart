...
class AcademicWordQuestModel extends AcademicWordQuest {
  const AcademicWordQuestModel({
    required super.id,
    super.type,
  ...
  factory AcademicWordQuestModel.fromJson(Map<String, dynamic> json) {
    return AcademicWordQuestModel(
