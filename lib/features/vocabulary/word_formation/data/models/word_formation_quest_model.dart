...
class WordFormationQuestModel extends WordFormationQuest {
  const WordFormationQuestModel({
    required super.id,
    super.type,
  ...
  factory WordFormationQuestModel.fromJson(Map<String, dynamic> json) {
    return WordFormationQuestModel(
