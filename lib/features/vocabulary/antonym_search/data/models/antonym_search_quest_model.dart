...
class AntonymSearchQuestModel extends AntonymSearchQuest {
  const AntonymSearchQuestModel({
    required super.id,
    super.type,
  ...
  factory AntonymSearchQuestModel.fromJson(Map<String, dynamic> json) {
    return AntonymSearchQuestModel(
