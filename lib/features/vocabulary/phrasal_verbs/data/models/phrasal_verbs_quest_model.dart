...
class PhrasalVerbsQuestModel extends PhrasalVerbsQuest {
  const PhrasalVerbsQuestModel({
    required super.id,
    super.type,
  ...
  factory PhrasalVerbsQuestModel.fromJson(Map<String, dynamic> json) {
    return PhrasalVerbsQuestModel(
