...
class TopicVocabScreen extends StatefulWidget {
  final int level;
  const TopicVocabScreen({super.key, required this.level});
      ...
      children: [
                ...
                children: [
                  ...
                  GlassTile(
                    ...
                    child: Column(
                      children: [
                        Text(
                          "Select the most appropriate term for:",
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            subtitle:
                "Usage Tip: ${quest.explanation ?? "Learning words in specific topics helps build deeper context."}",
            onContinue: () =>
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        ...
        description:
            'You earned $xp XP and $coins Coins. You\'re mastering specialized vocabulary!',
        buttonText: 'HURRAY',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        ...
        description: 'Every topic is a new world. Practice again!',
        buttonText: 'RETRY',
        isSuccess: false,
        onButtonPressed: () {
          Navigator.pop(c);
