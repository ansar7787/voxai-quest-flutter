...
class TopicVocabQuestModel extends TopicVocabQuest {
  const TopicVocabQuestModel({
    required super.id,
    super.type,
  ...
  factory TopicVocabQuestModel.fromJson(Map<String, dynamic> json) {
    return TopicVocabQuestModel(
