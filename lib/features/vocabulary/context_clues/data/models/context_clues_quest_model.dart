...
class ContextCluesQuestModel extends ContextCluesQuest {
  const ContextCluesQuestModel({
    required super.id,
    super.type,
  ...
  factory ContextCluesQuestModel.fromJson(Map<String, dynamic> json) {
    return ContextCluesQuestModel(
