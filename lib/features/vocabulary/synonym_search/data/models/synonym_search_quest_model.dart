...
class SynonymSearchQuestModel extends SynonymSearchQuest {
  const SynonymSearchQuestModel({
    required super.id,
    super.type,
  ...
  factory SynonymSearchQuestModel.fromJson(Map<String, dynamic> json) {
    return SynonymSearchQuestModel(
