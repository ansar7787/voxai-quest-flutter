...
class FlashcardsQuestModel extends FlashcardsQuest {
  const FlashcardsQuestModel({
    required super.id,
    super.type,
  ...
  factory FlashcardsQuestModel.fromJson(Map<String, dynamic> json) {
    return FlashcardsQuestModel(
