...
class GrammarQuestQuestModel extends GrammarQuestQuest {
  const GrammarQuestQuestModel({
    required super.id,
    super.type,
  ...
  factory GrammarQuestQuestModel.fromJson(Map<String, dynamic> json) {
    return GrammarQuestQuestModel(
