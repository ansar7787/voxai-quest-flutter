...
class QuestionFormatterQuestModel extends QuestionFormatterQuest {
  const QuestionFormatterQuestModel({
    required super.id,
    super.type,
  ...
  factory QuestionFormatterQuestModel.fromJson(Map<String, dynamic> json) {
    return QuestionFormatterQuestModel(
