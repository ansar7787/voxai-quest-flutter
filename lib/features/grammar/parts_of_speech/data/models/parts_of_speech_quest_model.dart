...
class PartsOfSpeechQuestModel extends PartsOfSpeechQuest {
  const PartsOfSpeechQuestModel({
    required super.id,
    super.type,
  ...
  factory PartsOfSpeechQuestModel.fromJson(Map<String, dynamic> json) {
    return PartsOfSpeechQuestModel(
