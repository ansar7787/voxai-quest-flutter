...
class _VoiceSwapScreenState extends State<VoiceSwapScreen> {
  ...
  void initState() {
    ...
    context.read<GrammarBloc>().add(
      FetchGrammarQuests(gameType: GameSubtype.voiceSwap, level: widget.level),
    );
  }
      ...
      children: [
                    ...
                    GlassTile(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            quest.question ??
                                "Switch the voice of this sentence...",
                            style: GoogleFonts.outfit(
                              fontSize: 18.sp,
                              fontWeight: FontWeight.w800,
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            subtitle:
                quest.explanation ??
                "Passive voice focuses on the action, not the actor!",
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Active Master!',
        description:
            'You earned $xp XP and $coins Coins for mastering voice transitions!',
        buttonText: 'HURRAY',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
