...
class SubjectVerbAgreementQuestModel extends SubjectVerbAgreementQuest {
  const SubjectVerbAgreementQuestModel({
    required super.id,
    super.type,
  ...
  factory SubjectVerbAgreementQuestModel.fromJson(Map<String, dynamic> json) {
    return SubjectVerbAgreementQuestModel(
