...
class SentenceCorrectionBloc extends Bloc<SentenceCorrectionEvent, SentenceCorrectionState> {
  final GetSentenceCorrectionQuests getQuests;

  SentenceCorrectionBloc({required this.getQuests}) : super(SentenceCorrectionInitial()) {
  ...
  void _onNextQuestion(
    ...
    if (state is SentenceCorrectionLoaded) {
      ...
      if (nextIndex >= state.quests.length) {
        ...
        emit(SentenceCorrectionGameComplete(
