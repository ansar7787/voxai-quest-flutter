...
class SentenceCorrectionQuestModel extends SentenceCorrectionQuest {
  const SentenceCorrectionQuestModel({
    required super.id,
    super.type,
  ...
  factory SentenceCorrectionQuestModel.fromJson(Map<String, dynamic> json) {
    return SentenceCorrectionQuestModel(
