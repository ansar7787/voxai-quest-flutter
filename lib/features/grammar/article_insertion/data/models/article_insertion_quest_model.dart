...
class ArticleInsertionQuestModel extends ArticleInsertionQuest {
  const ArticleInsertionQuestModel({
    required super.id,
    super.type,
  ...
  factory ArticleInsertionQuestModel.fromJson(Map<String, dynamic> json) {
    return ArticleInsertionQuestModel(
      ...
      articleToInsert: json['articleToInsert'] as String?,
    );
  }
