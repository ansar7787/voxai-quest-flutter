...
class ClauseConnectorQuestModel extends ClauseConnectorQuest {
  const ClauseConnectorQuestModel({
    required super.id,
    super.type,
  ...
  factory ClauseConnectorQuestModel.fromJson(Map<String, dynamic> json) {
    return ClauseConnectorQuestModel(
      ...
      firstClause: json['firstClause'] as String?,
      secondClause: json['secondClause'] as String?,
      connectorToUse: json['connectorToUse'] as String?,
    );
  }
