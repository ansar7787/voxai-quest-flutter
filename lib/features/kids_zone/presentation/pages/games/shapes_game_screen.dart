...
class ShapesGameScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return KidsGameBaseScreen(
      ...
      backgroundColors: const [Color(0xFFD1FAE5), Color(0xFFF0FDF4)],
      buildGameUI: (context, state) {
        ...
        return Column(
          children: [
            ...
            _buildShapeDisplay(quest.question ?? "", quest.imageUrl),
  ...
  Widget _buildShapeDisplay(String shapeName, String? imageUrl) {
    return Container(
      width: 180.r,
      height: 180.r,
      ...
      child: KidsImage(
        imageUrl: imageUrl,
        fallbackIcon: _getIconData(shapeName),
        iconColor: const Color(0xFF10B981),
      ),
    );
  }

  IconData _getIconData(String shapeName) {
