...
class AlphabetGameScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return KidsGameBaseScreen(
      ...
      backgroundColors: const [Color(0xFFFFE4E6), Color(0xFFFFF1F2)],
      buildGameUI: (context, state) {
        ...
        return Column(
          children: [
            ...
            _buildGiantLetter(quest.question ?? "?", quest.imageUrl),
  ...
  Widget _buildGiantLetter(String letter, String? imageUrl) {
    return Container(
      width: 180.r,
      height: 180.r,
