...
class NatureGameScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return KidsGameBaseScreen(
      ...
      backgroundColors: const [Color(0xFFDCFCE7), Color(0xFFF0FDF4)],
      buildGameUI: (context, state) {
        ...
        return Column(
          children: [
            ...
            _buildNatureCard(quest.imageUrl),
            SizedBox(height: 40.h),
            Padding(
  ...
  Widget _buildNatureCard(String? imageUrl) {
    return Container(
      width: 240.r,
      height: 240.r,
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(50.r), // Organic rounded corners
        boxShadow: [
          BoxShadow(
