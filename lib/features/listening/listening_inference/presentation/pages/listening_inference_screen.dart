...
class ListeningInferenceScreen extends StatefulWidget {
  final int level;
  const ListeningInferenceScreen({super.key, required this.level});
  ...
  void initState() {
    ...
    context.read<ListeningBloc>().add(
      FetchListeningQuests(
        gameType: GameSubtype.listeningInference,
        level: widget.level,
      ),
    );
  }
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildAudioPlayer(
                        quest.transcript ?? "Listen to the implicit message.",
                        theme,
                      ),
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect!
                ? "GENIUS DEDUCTION!"
                : "MISSED CONNECTION!",
            subtitle: "The truth is often found between the lines.",
    ...
    return GlassTile(
      ...
      child: Column(
        children: [
          ...
          Text(
            _isPlaying ? "DECODING MEANING..." : "HEAR THE SCENARIO",
            style: GoogleFonts.outfit(
              fontSize: 12.sp,
              fontWeight: FontWeight.w800,
              letterSpacing: 2,
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (context) => ModernGameDialog(
        ...
        description:
            "You see what others only hear. Earned $xp XP and $coins coins.",
        buttonText: "CONTINUE",
        onButtonPressed: () {
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => ModernGameDialog(
        ...
        description: "Implicit meanings can be tricky. Want to try again?",
        buttonText: "RETRY",
        isSuccess: false,
        onButtonPressed: () {
          Navigator.pop(context);
