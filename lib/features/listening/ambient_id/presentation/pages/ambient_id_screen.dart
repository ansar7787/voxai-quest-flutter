...
class AmbientIdScreen extends StatefulWidget {
  final int level;
  const AmbientIdScreen({super.key, required this.level});
...
class _AmbientIdScreenState extends State<AmbientIdScreen> {
  ...
  void initState() {
    ...
    context.read<ListeningBloc>().add(
      FetchListeningQuests(
        gameType: GameSubtype.ambientId,
        level: widget.level,
      ),
    );
  }
  ...
  Widget _buildGameUI(
    ...
    final options =
        quest.options ??
        ['City Traffic', 'Forest Birds', 'Ocean Waves', 'Rainy Cafe'];
      ...
      children: [
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildAudioPlayer(
                        quest.transcript ??
                            "Ambient sound of a busy forest with birds chirping.",
                        theme,
                      ),
                      SizedBox(height: 40.h),
                      _buildOptionsGrid(
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect! ? "SHARP EARS!" : "KEEP LISTENING!",
            subtitle: "Every sound tells a story.",
    ...
    return GlassTile(
      ...
      child: Column(
        children: [
            ...
            children: [
              if (_isPlaying)
                SizedBox(
                  width: 120.r,
                  height: 120.r,
                  child: const SoundWave(color: Colors.white),
                ),
              ScaleButton(
          ...
          Text(
            _isPlaying ? "ANALYZING AMBIENCE..." : "TAP TO LISTEN",
            style: GoogleFonts.outfit(
              fontSize: 14.sp,
              fontWeight: FontWeight.w800,
              letterSpacing: 2,
  ...
  Widget _buildOptionCard(
    ...
    return ScaleButton(
      ...
      child: GlassTile(
        ...
        color: isSelected ? theme.primaryColor.withValues(alpha: 0.2) : null,
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (context) => ModernGameDialog(
        title: "AMBIENT MASTER!",
        description:
            "You have a natural gift for auditory context! Earned $xp XP and $coins coins.",
        buttonText: "CONTINUE",
        onButtonPressed: () {
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => ModernGameDialog(
        title: "SIGNAL LOST",
        description:
            "The background noise got the better of you. Ready to recalibrate?",
        isSuccess: false,
        isRescueLife: true,
        buttonText: 'GIVE UP',
        onButtonPressed: () {
