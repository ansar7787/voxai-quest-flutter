...
class WritingEmailQuestModel extends WritingEmailQuest {
  const WritingEmailQuestModel({
    required super.id,
    super.type,
  ...
  factory WritingEmailQuestModel.fromJson(Map<String, dynamic> json) {
    return WritingEmailQuestModel(
