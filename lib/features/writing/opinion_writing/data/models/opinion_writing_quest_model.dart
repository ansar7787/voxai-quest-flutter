...
class OpinionWritingQuestModel extends OpinionWritingQuest {
  const OpinionWritingQuestModel({
    required super.id,
    super.type,
  ...
  factory OpinionWritingQuestModel.fromJson(Map<String, dynamic> json) {
    return OpinionWritingQuestModel(
      ...
      viewpoints: (json['viewpoints'] as List<dynamic>?)?.map((e) => e as String).toList(),
    );
  }
