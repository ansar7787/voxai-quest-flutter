...
class EssayDraftingQuestModel extends EssayDraftingQuest {
  const EssayDraftingQuestModel({
    required super.id,
    super.type,
    ...
    super.topic,
    super.mainPoints,
    super.wordCountRequirement,
  });

  factory EssayDraftingQuestModel.fromJson(Map<String, dynamic> json) {
    return EssayDraftingQuestModel(
