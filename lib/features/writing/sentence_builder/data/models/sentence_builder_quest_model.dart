...
class SentenceBuilderQuestModel extends SentenceBuilderQuest {
  const SentenceBuilderQuestModel({
    required super.id,
    super.type,
    ...
    super.hint,
    super.prompt,
    super.scrambledWords,
  });

  factory SentenceBuilderQuestModel.fromJson(Map<String, dynamic> json) {
    return SentenceBuilderQuestModel(
      ...
      scrambledWords: (json['scrambledWords'] as List<dynamic>?)?.map((e) => e as String).toList(),
    );
  }
