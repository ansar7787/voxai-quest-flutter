...
class CompleteSentenceQuestModel extends CompleteSentenceQuest {
  const CompleteSentenceQuestModel({
    required super.id,
    super.type,
  ...
  factory CompleteSentenceQuestModel.fromJson(Map<String, dynamic> json) {
    return CompleteSentenceQuestModel(
      ...
      partialSentence: json['partialSentence'] as String?,
