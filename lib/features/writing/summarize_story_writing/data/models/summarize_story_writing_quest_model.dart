...
class SummarizeStoryWritingQuestModel extends SummarizeStoryWritingQuest {
  const SummarizeStoryWritingQuestModel({
    required super.id,
    super.type,
  ...
  factory SummarizeStoryWritingQuestModel.fromJson(Map<String, dynamic> json) {
    return SummarizeStoryWritingQuestModel(
