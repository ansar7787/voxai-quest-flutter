...
class SummarizeStoryWritingScreen extends StatefulWidget {
  final int level;
  const SummarizeStoryWritingScreen({super.key, required this.level});
...
class _SummarizeStoryWritingScreenState
  ...
  void initState() {
    ...
    context.read<WritingBloc>().add(
      FetchWritingQuests(
        gameType: GameSubtype.summarizeStoryWriting,
        level: widget.level,
      ),
    );
  }
  ...
  void _submitAnswer() {
    ...
    // Validate: At least 20 chars and 4 words for a summary
    bool isCorrect =
                  ...
                  children: [
                    ...
                    GlassTile(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 16.h),
                          Text(
                            quest.prompt ?? "No story content provided.",
                    ...
                    if (state.hintUsed)
                      Padding(
                        ...
                        child: Text(
                          "Hint: ${quest.hint ?? 'Summarize the main points.'}",
                          style: GoogleFonts.outfit(
                            fontSize: 14.sp,
                            color: Colors.amber,
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect!
                ? "WELL SUMMARIZED!"
                : "STORY INCOMPLETE!",
            subtitle: quest.sampleAnswer ?? "Summary recorded.",
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Story Locked',
        description: 'You lost all hearts. Try to focus on the key points!',
        isSuccess: false,
        isRescueLife: true,
        buttonText: 'GIVE UP',
        onButtonPressed: () {
