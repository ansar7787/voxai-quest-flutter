...
class RepeatSentenceQuestModel extends RepeatSentenceQuest {
  const RepeatSentenceQuestModel({
    required super.id,
    super.type,
  ...
  factory RepeatSentenceQuestModel.fromJson(Map<String, dynamic> json) {
    return RepeatSentenceQuestModel(
