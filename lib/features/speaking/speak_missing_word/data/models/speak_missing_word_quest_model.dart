...
class SpeakMissingWordQuestModel extends SpeakMissingWordQuest {
  const SpeakMissingWordQuestModel({
    required super.id,
    super.type,
  ...
  factory SpeakMissingWordQuestModel.fromJson(Map<String, dynamic> json) {
    return SpeakMissingWordQuestModel(
