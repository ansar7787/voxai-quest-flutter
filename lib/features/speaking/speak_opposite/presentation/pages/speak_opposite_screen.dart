...
class _SpeakOppositeScreenState extends State<SpeakOppositeScreen> {
  ...
  void _analyzeSpeech() {
    ...
    bool isCorrect =
        ...
        (targetText.contains(utteredText) && utteredText.length > 3);
      ...
      children: [
                    ...
                    if (state.hintUsed)
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            "Hint: Starts with '${quest.correctAnswer?[0].toUpperCase() ?? ""}'",
                            style: GoogleFonts.outfit(
                              fontSize: 16.sp,
                              color: Colors.amber,
        ...
        if (state.lastAnswerCorrect != null)
          ModernGameResultOverlay(
            ...
            title: state.lastAnswerCorrect! ? "SHARP OPPOSITE!" : "TRY AGAIN!",
            subtitle: "Correct Answer: ${quest.correctAnswer ?? 'Perfect!'}",
            onContinue: () {
              setState(() {
                _recognizedText = '';
                _hasAnalyzed = false;
  ...
  void _showCompletionDialog(BuildContext context, int xp, int coins) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        title: 'Antonym Ace!',
        description:
            'You earned $xp XP and $coins Coins for knowing your opposites!',
        buttonText: 'GREAT',
        onButtonPressed: () {
          Navigator.pop(c);
          context.pop();
  ...
  void _showGameOverDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (c) => ModernGameDialog(
        ...
        description:
            'Your antonym library is currently empty. Recharge and try again!',
        buttonText: 'RETRY',
        isSuccess: false,
