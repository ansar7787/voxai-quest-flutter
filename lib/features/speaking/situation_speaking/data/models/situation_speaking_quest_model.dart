...
class SituationSpeakingQuestModel extends SituationSpeakingQuest {
  const SituationSpeakingQuestModel({
    required super.id,
    super.type,
  ...
  factory SituationSpeakingQuestModel.fromJson(Map<String, dynamic> json) {
    return SituationSpeakingQuestModel(
