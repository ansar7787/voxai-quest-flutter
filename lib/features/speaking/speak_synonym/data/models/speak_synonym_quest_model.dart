...
class SpeakSynonymQuestModel extends SpeakSynonymQuest {
  const SpeakSynonymQuestModel({
    required super.id,
    super.type,
  ...
  factory SpeakSynonymQuestModel.fromJson(Map<String, dynamic> json) {
    return SpeakSynonymQuestModel(
