...
class ParagraphSummaryQuestModel extends ParagraphSummaryQuest {
  const ParagraphSummaryQuestModel({
    required super.id,
    super.type,
  ...
  factory ParagraphSummaryQuestModel.fromJson(Map<String, dynamic> json) {
    return ParagraphSummaryQuestModel(
