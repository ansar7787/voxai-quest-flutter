...
class ReadingSpeedCheckQuestModel extends ReadingSpeedCheckQuest {
  const ReadingSpeedCheckQuestModel({
    required super.id,
    super.type,
  ...
  factory ReadingSpeedCheckQuestModel.fromJson(Map<String, dynamic> json) {
    return ReadingSpeedCheckQuestModel(
