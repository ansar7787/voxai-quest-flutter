...
class FindWordMeaningQuestModel extends FindWordMeaningQuest {
  const FindWordMeaningQuestModel({
    required super.id,
    super.type,
  ...
  factory FindWordMeaningQuestModel.fromJson(Map<String, dynamic> json) {
    return FindWordMeaningQuestModel(
