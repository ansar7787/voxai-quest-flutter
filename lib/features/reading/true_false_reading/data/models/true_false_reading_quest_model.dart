...
class TrueFalseReadingQuestModel extends TrueFalseReadingQuest {
  const TrueFalseReadingQuestModel({
    required super.id,
    super.type,
  ...
  factory TrueFalseReadingQuestModel.fromJson(Map<String, dynamic> json) {
    return TrueFalseReadingQuestModel(
