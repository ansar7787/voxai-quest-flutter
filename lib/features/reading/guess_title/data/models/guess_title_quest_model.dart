...
class GuessTitleQuestModel extends GuessTitleQuest {
  const GuessTitleQuestModel({
    required super.id,
    super.type,
  ...
  factory GuessTitleQuestModel.fromJson(Map<String, dynamic> json) {
    return GuessTitleQuestModel(
