...
class ReadAndAnswerQuestModel extends ReadAndAnswerQuest {
  const ReadAndAnswerQuestModel({
    required super.id,
    super.type,
  ...
  factory ReadAndAnswerQuestModel.fromJson(Map<String, dynamic> json) {
    return ReadAndAnswerQuestModel(
